...
def test_maybe_refine_intrinsics_applies_mapper_override() -> None:
...
def test_maybe_refine_intrinsics_keeps_original_when_mapper_returns_none() -> None:
    mapping_result = _mapping_result()
...
def test_mapping_without_world_points_forces_unprojection_path() -> None:
    mapping_result = _mapping_result()
...
def test_maybe_refine_intrinsics_rescales_processing_frame_intrinsics() -> None:
    mapping_result = _mapping_result()
