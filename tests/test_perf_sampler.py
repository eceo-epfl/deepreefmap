...
from deepreefmap.perf_sampler import ResourceSample, ResourceSampler, peaks_from_marks

# Same span shape as the orchestrator's _STAGE_SPANS: (begin_mark, end_mark, stage).
_SPANS = (
...
def test_vram_none_when_no_sample_reported_it():
    marks = {"start": 0.0, "preprocess": 10.0}
