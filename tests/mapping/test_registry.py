...
def test_list_mapping_backends_includes_loger_star() -> None:
...
def test_create_scsfmlearner_backend_uses_registered_name() -> None:
...
def test_create_scsfmlearner_backend_accepts_custom_target_size() -> None:
    with patch.object(SCSfMLearnerBackend, "_load_models", lambda self: None):
...
def test_create_loger_star_uses_star_checkpoint_defaults() -> None:
