...
def test_rotation_matrix_from_vectors_aligns_source_to_target() -> None:
...
def test_align_poses_to_gravity_rotates_camera_orientation() -> None:
...
def test_default_sequence_backend_applies_gravity_correction() -> None:
...
def test_align_poses_to_gravity_accumulates_relative_motion_like_legacy() -> None:
    poses = np.stack(
        [
