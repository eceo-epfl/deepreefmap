...
def test_extract_gravity_vectors_for_video_selection_matches_sampled_frames(monkeypatch) -> None:
...
def test_extract_gravity_vectors_for_video_selection_returns_none_when_stream_missing(monkeypatch) -> None:
    monkeypatch.setattr(gopro.iio, "immeta", lambda path: {"fps": 2, "nframes": 4})
...
def test_extract_gravity_vectors_for_video_selection_skips_unselected_clips(monkeypatch) -> None:
