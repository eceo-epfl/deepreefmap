...
def test_save_semantic_cloud_round_trip(tmp_path) -> None:
...
def test_save_semantic_cloud_omits_optional_fields(tmp_path) -> None:
    path = tmp_path / "cloud.ply"
    cloud = SemanticPointCloud(
...
def test_save_geometry_cloud_round_trip(tmp_path) -> None:
...
def test_load_geometry_cloud_inverts_save(tmp_path) -> None:
    path = tmp_path / "geom.ply"
...
def test_save_ortho_grid_contains_expected_keys(tmp_path) -> None:
