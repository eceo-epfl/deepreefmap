...
def test_iter_video_frames_applies_concatenated_time_window(monkeypatch) -> None:
    frames = {
...
def test_estimated_frame_count_matches_iterator_for_end_exclusive_window(monkeypatch) -> None:
    path = Path("clip.mp4")
...
def test_estimated_frame_count_matches_iterator_for_non_integer_source_fps(monkeypatch) -> None:
    path = Path("clip.mp4")
...
def test_timestamp_sampler_honors_target_fps_when_source_is_not_multiple(monkeypatch) -> None:
    path = Path("clip.mp4")
